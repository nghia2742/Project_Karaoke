            ...
            <div class="block2-1">
                <form method="POST">
                    <div class="item_info">
                        ...
                        <input name="name" type="text" id="nameRoom">

                        <label for="status">Tình trạng:</label>
                        <input name="status" type="text" id="statusRoom">
                        
                        <label for="money">Giá tiền:</label>
                        <input name="money" type="int" id="priceRoom">
    
                        <label for="kind">Loại phòng:</label>
                        <input name="kind" type="text">
                        
                        <label for="space">Không gian:</label>
                        <input name="space" type="text" id="capacityRoom">
                    </div>
            </div>  
            <div class="block2-2">
                <a href="./Main.php" target="_self" >
                    <button onclick="addRoom()" id = "btnAdd" type = 'submit' name ='insert' class="btn_order">Accept</button>
                </a>
            </div>
            </form>            
        </div>
